        ...
        <div className="flex flex-1 gap-6 pl-5 md:gap-5 ">
            <nav>
                <ul className="flex items-center">
                    ...
                    <li className={`flex items-center border-b-first-color hover:border-b-first-color hover:border-b-2 h-11 ${path.includes("user") && "border-b-2"}`}>
                        <Link href="/user"><Button className="text-lg" variant="ghost">User</Button></Link>
                    </li>
                </ul>
            </nav>
        </div>
