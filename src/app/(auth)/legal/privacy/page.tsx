...
export default function PrivacyPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <p>Si tienes alguna duda sobre esta Política de Privacidad, puedes contactarte con nosotros a través de <a href="mailto:trafficker@tinta.wine" className="font-bold">trafficker@tinta.wine</a>.</p>
